...
public class Cart extends javax.swing.JFrame {
    ...
    private static final String CollectionsName = "facture";
    private static MongoClient mongoClient;
    private static MongoDatabase database;
    private static MongoCollection<Document> collection;
    private static MongoCollection<Document> collections;
    private static MongoCollection<Document> collections1;
    ...
    public Cart() {
        ...
        collections1 = database.getCollection(CollectionsName);
    ...
    private void initComponents() {
        ...
        btnSaveFacture.setText("Guardar Factura");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                ...
                                .addComponent(btnDelate, javax.swing.GroupLayout.DEFAULT_SIZE, 41, Short.MAX_VALUE)
                                .addComponent(btnSaveFacture, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
        );
...
try {
    ...
    private void btnSaveFactureActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveFactureActionPerformed
        ...
        String cell2 = txtCI.getText();
        String cell3 = txtAddress.getText();
        String cell4 = txtPrice.getText();
        String cell5 = txtIva.getText();
        String cell6 = txtTotalPrice.getText();
        if (cell1.isEmpty() || cell2.isEmpty() || cell3.isEmpty() || cell4.isEmpty() || cell5.isEmpty() || cell6.isEmpty() ) {
        JOptionPane.showMessageDialog(this, "No se ha guardado la factura, las celdas estan vacias", "Error", JOptionPane.ERROR_MESSAGE);
    } else {
        readData(); 
        Gson gson = new Gson();
    ...
    private void readData() {
       ...
       cart = new Cart(Name,CI,Address,Price,Iva,TotalPrice);
    }
