...
private MongoClient mongoClient;
    ...
    try {
        ...
        if (existingUser != null) {
            String stored = existingUser.getString("password"); // Obtén la contraseña encriptada desde el documento

            AESCipher aesCipher = new AESCipher();
            String storedDecrypted = aesCipher.descifra(stored); // Desencripta la contraseña almacenada

            if (storedDecrypted.equals(password)) { // Compara la contraseña desencriptada con la ingresada por el usuario
