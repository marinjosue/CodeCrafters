...
public class newUser {
    ...
    public newUser(String nombre, String apellido, String ci, String direccion, String email, String usuario) {
        this.nombre = nombre;
    ...
    public static boolean validar(newUser user, MongoCollection<Document> collection) {
        if (user.nombre.isEmpty() || user.apellido.isEmpty() || user.ci.isEmpty() || user.direccion.isEmpty() || user.email.isEmpty() || user.usuario.isEmpty()) {
    ...
    public static void registrar(newUser user, MongoCollection<Document> collection) {
        ...
        document.append("Usuario", user.usuario);
