...
try {
    ...
    if (document != null) {
        ...
        if (stock > 0) {
            int quantityToAdd = 1; // Cantidad inicial a agregar al carrito
            ...
            if (!productExists) {
                // Si el producto no existe, agregarlo al carrito con la cantidad inicial
                Product product = new Product(id, name, quantityToAdd, price);
